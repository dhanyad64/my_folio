...
import 'package:my_folio/utils/helper.dart';

class AppColors {
  AppColors._();

  static const int primaryColor = 0xff101826;
  static const int primaryColorLight = 0xffDEFFFF;
  static const int primaryColorDark = 0xff06090e;

  static MaterialColor primaryMaterialColor =
      getSwatch(const Color(0xff101826));
  static MaterialColor primaryMaterialColorDark =
      getSwatch(const Color(0xff06090e));
